...
evaluation = dict(interval=200, class_splits=['BASE_CLASSES_SPLIT1', 'NOVEL_CLASSES_SPLIT1'])
...
model = dict(
    roi_head=dict(
        ...
        with_refine=True,
        proto_weight=0.6,   # 5-shot微调阶段的原型权重
        momentum=0.997,     # 样本增加，提高动量系数
        temperature=0.09,   # 调整温度参数
